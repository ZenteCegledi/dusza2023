  ...
  return (
    ...
    <div className="relative flex flex-col justify-center h-screen overflow-hidden">
        <div className="w-full p-6 m-auto bg-black rounded-md shadow-md lg:max-w-lg">
            <h1 className="text-3xl font-semibold text-center text-white-700">((SiteName))</h1>
            <form className="space-y-4">
                ...
                <div>
                    <button className="btn w-full bg-blue-900 hover:bg-blue-700 ">Bejelentkezés</button>
                </div>
            </form>
        </div>
    </div>
